Feature: CanTp_GetVersion API
  ...
  @fixture.can_tp
  Scenario: When requesting the version information of the CanTp module, the pVersionInfo parameter
  vendorID = 0, moduleID = 14, sw_major_version = 0, sw_minor_version = 1 and sw_major_version = 0.
