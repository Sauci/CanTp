...
void CanTp_Init(const CanTp_ConfigType *pConfig)
{
    if(pConfig == ((void *)0x00u))     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x01u), (0x03u));
                           return;     }
    ...
    if (result != (0x00u))
    {
        if((0x01u))     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x01u), (0x04u));         ;     }
    }
    else
    {
...
void CanTp_GetVersionInfo(Std_VersionInfoType *pVersionInfo)
{
    if(pVersionInfo == ((void *)0x00u))     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x07u), (0x03u));
                           return;     }
...
void CanTp_Shutdown(void)
{
    if(CanTp_State == CANTP_OFF)     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x02u), (0x20u));
                           return;     }
...
Std_ReturnType CanTp_Transmit(PduIdType txPduId, const PduInfoType *pPduInfo)
{
    ...
    if(CanTp_State == CANTP_OFF)     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x49u), (0x20u));
                           return (0x01u);     }
    ...
    if(pPduInfo == ((void *)0x00u))     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x49u), (0x03u));
                           return (0x01u);     }
...
Std_ReturnType CanTp_CancelTransmit(PduIdType txPduId)
{
    ...
    if(CanTp_State == CANTP_OFF)     {         (void)Det_ReportError((0x0Eu), 0x00u, api_id, (0x20u));
                           return tmp_return;     }
        ...
        ((p_n_sdu->dir & (0x02u)) != 0x00u))
    {
        ...
        else
        {
            ...
            if((0x01u))     {         (void)Det_ReportRuntimeError((0x0Eu), 0x00u, api_id, (0xA0u));         ;     }
        }
    }
    else
    {
        if((0x01u))     {         (void)Det_ReportError((0x0Eu), 0x00u, api_id, (0x02u));         ;     }
    }
...
Std_ReturnType CanTp_CancelReceive(PduIdType rxPduId)
{
    ...
    if ((CanTp_GetNSduFromPduId(rxPduId, &p_n_sdu) == (0x00u)) &&
        ((p_n_sdu->dir & (0x01u)) != 0x00u))
    {
        ...
        if (task_state == CANTP_PROCESSING)
        {
            ...
            if ((p_n_sdu->pci != CANTP_N_PCI_TYPE_SF) &&
                ((p_n_sdu->rx.shared.flag & (0x01u << 0x0Cu)) == 0x00u))
            {
...
Std_ReturnType CanTp_ReadParameter(PduIdType pduId, TPParameterType parameter, uint16 *pValue)
{
    ...
    if(pValue == ((void *)0x00u))     {         (void)Det_ReportError((0x0Eu), 0x00u, api_id, (0x03u));
                           return tmp_return;     }
...
void CanTp_MainFunction(void)
{
    if(CanTp_State == CANTP_OFF)     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x06u), (0x20u));         ;     }
...
static boolean CanTp_NetworkLayerTimedOut(CanTp_NSduType *pNSdu, const uint8 instanceId)
{
    ...
    switch (instanceId)
    {
        case (0x00u):
        {
            result = (boolean)((pNSdu->n[(0x00u)] >= pNSdu->tx.cfg->nas) &&
                               ((pNSdu->t_flag & (0x01u << (0x00u))) != 0x00u));
            break;
        }
        case (0x01u):
        {
            result = (boolean)((pNSdu->n[(0x01u)] >= pNSdu->tx.cfg->nbs) &&
                               ((pNSdu->t_flag & (0x01u << (0x01u))) != 0x00u));
            break;
        }
        case (0x02u):
        {
            result = (boolean)((pNSdu->n[(0x02u)] >= pNSdu->tx.cfg->ncs) &&
                               ((pNSdu->t_flag & (0x01u << (0x02u))) != 0x00u));
            break;
        }
        case (0x03u):
        {
            result = (boolean)((pNSdu->n[(0x03u)] >= pNSdu->rx.cfg->nar) &&
                               ((pNSdu->t_flag & (0x01u << (0x03u))) != 0x00u));
            break;
        }
        case (0x04u):
        {
            result = (boolean)((pNSdu->n[(0x04u)] >= pNSdu->rx.cfg->nbr) &&
                               ((pNSdu->t_flag & (0x01u << (0x04u))) != 0x00u));
            break;
        }
        case (0x05u):
        {
            result = (boolean)((pNSdu->n[(0x05u)] >= pNSdu->rx.cfg->ncr) &&
                               ((pNSdu->t_flag & (0x01u << (0x05u))) != 0x00u));
            break;
        }
        default:
        {
...
static void CanTp_StartFlowControlTimeout(CanTp_NSduType *pNSdu, const uint8 direction)
{
    if (((direction & (0x01u)) != 0x00u) &&
        ((pNSdu->rx.shared.flag & (0x01u << 0x06u)) == 0x00u))
    {
    ...
    if (((direction & (0x02u)) != 0x00u) &&
        ((pNSdu->tx.shared.flag & (0x01u << 0x06u)) == 0x00u))
    {
...
void CanTp_RxIndication(PduIdType rxPduId, const PduInfoType *pPduInfo)
{
    ...
    if(pPduInfo == ((void *)0x00u))     {         (void)Det_ReportError((0x0Eu), 0x00u, (0x42u), (0x03u));
                           return;     }
    ...
    if ((CanTp_GetNSduFromPduId(rxPduId, &p_n_sdu) == (0x00u)) &&
        (CanTp_DecodePCIValue(&p_n_sdu->pci, &pPduInfo->SduDataPtr[0x00u]) == (0x00u)))
    {
            ...
            switch (p_n_sdu->pci)
            {
                ...
                case CANTP_N_PCI_TYPE_FF:
                {
                        ...
                        (p_n_sdu->dir == ((0x01u) | (0x02u))))
                    {
                        ...
                        if((0x01u))     {         (void)Det_ReportRuntimeError((0x0Eu), instance_id, 0x00u, (0x85u));         ;     }
                    }
                }
...
static void CanTp_AbortRxSession(CanTp_NSduType *pNSdu, const uint8 instanceId, const boolean confirm)
{
    ...
    if (instanceId != (0xFFu))
    {
        ...
        if((0x01u))     {         (void)Det_ReportError((0x0Eu), instanceId, 0x00u, (0xC0u));         ;     }
    }
}
...
static void CanTp_AbortTxSession(CanTp_NSduType *pNSdu, const uint8 instanceId, boolean confirm)
{
    ...
    if (instanceId != (0xFFu))
    {
        ...
        if((0x01u))     {         (void)Det_ReportError((0x0Eu), instanceId, 0x00u, (0xD0u));         ;     }
    }
}
...
static void CanTp_PerformStepRx(CanTp_NSduType *pNSdu)
{
    ...
    else if (CanTp_NetworkLayerTimedOut(p_n_sdu, (0x05u)) == (0x01u))
    {
...
static void CanTp_PerformStepTx(CanTp_NSduType *pNSdu)
{
    ...
    else if (CanTp_NetworkLayerTimedOut(p_n_sdu, (0x01u)) == (0x01u))
    {
    ...
    else if (CanTp_NetworkLayerTimedOut(p_n_sdu, (0x02u)) == (0x01u))
    {
    ...
    else
    {
        switch (p_n_sdu->tx.state)
        {
            ...
            case CANTP_TX_FRAME_STATE_WAIT_CF_TX_CONFIRMATION:
            {
                ...
                if (((p_n_sdu->tx.shared.flag & (0x01u << 0x0Au)) == 0x00u)
                    && ((CanTp_FlowControlTimedOut(p_n_sdu, (0x02u)) == (0x01u)) ||
                        ((p_n_sdu->tx.shared.flag & (0x01u << 0x06u)) == 0x00u)))
                {
